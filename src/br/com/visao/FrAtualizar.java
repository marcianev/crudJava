...
public class FrAtualizar extends javax.swing.JFrame {

    /**
     * Creates new form FrAtualizar
     */
    ...
    private void jBpesqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBpesqActionPerformed
        ...
        a.setCodigo(Integer.valueOf(jTmat.getText()));
        try {
            ...
            jTdisc.setText(a.getIdDisciplina()+"");
    ...
    private void jBatualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBatualizarActionPerformed
        ...
        try {
            ...
            a.setCodigo(Integer.valueOf(jTmat.getText()));
            a.setIdDisciplina(Integer.valueOf(jTdisc.getText()));
            dao.editarAluno(a);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrAtualizar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrAtualizar().setVisible(true);
            }
        });
    }
